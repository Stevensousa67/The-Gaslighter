    ...
    <div className="flex min-h-svh flex-col lg:flex-row">
        ...
        <div className="flex max-w-sm flex-col items-center gap-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xl font-medium text-primary-foreground/80">
              The world&apos;s most confident contrarian
            </p>
          </div>
          <p className="text-sm text-primary-foreground/60 text-balance leading-relaxed">
            Sign in to have your beliefs professionally dismantled.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-12 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center lg:hidden">
          ...
          <p className="text-sm text-muted-foreground">The world&apos;s most confident contrarian</p>
        </div>

        <Card className="w-full max-w-sm">
          <CardHeader>
            <CardTitle className="text-xl">Welcome back</CardTitle>
            <CardDescription>Sign in to continue being wrong</CardDescription>
          </CardHeader>
